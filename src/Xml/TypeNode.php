...
class TypeNode extends XmlNode
{
    ...
    public function isArray()
    {
        ...
        // Array types are complex types with one element, their names begins with 'ArrayOf'. So if not - that's not array.
        if (!$this->isComplex()
            || count($parts) !== 1
        ...
        // Check if only field is array
        return substr($varType, -2, 2) == '[]';
    }
